                ...
                {onHold.map((t) => (
                  <div key={t.id} className="flex items-center gap-2.5 bg-gray-50 dark:bg-white/[0.04] rounded-xl p-2.5">
                    ...
                    <div className="flex gap-1.5 flex-shrink-0">
                      <button
                        onClick={() => approveMut.mutate({ taskId: t.id, holdId: t.id })}
                        className="w-7 h-7 rounded-xl bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 hover:bg-green-200 flex items-center justify-center transition-colors"
                      >
                        <Check size={13} strokeWidth={2.5} />
                      </button>
                      <button
                        onClick={() => rejectMut.mutate({ taskId: t.id, holdId: t.id })}
                        className="w-7 h-7 rounded-xl bg-red-100 dark:bg-red-900/40 text-red-600 dark:text-red-400 hover:bg-red-200 flex items-center justify-center transition-colors"
                      >
